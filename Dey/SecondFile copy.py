...
def fetch_stock_data():
    api_url = f'https://api.polygon.io/v2/aggs/ticker/APPL/range/30/minute/2024-04-01/2024-04-01?adjusted=true&sort=asc&limit=500&apiKey=7JbEpLM6e6J0nsQk8BS8kVKKJbFhDAIO'
    stock= []
    roundtripcounter = 0
...
stock_df2.to_csv('/workspaces/Repo_ACCPythonAnalytics202403/Dey/File.csv', index=False)
df2 = pd.read_csv('/workspaces/Repo_ACCPythonAnalytics202403/Dey/File.csv')
print(df2.head(10))